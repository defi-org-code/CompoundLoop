...
const CompoundLoop = contract.fromArtifact("CompoundLoop"); // Loads a compiled contract
const ERC20 = contract.fromArtifact("IERC20"); // Loads a compiled contract
const CERC20 = contract.fromArtifact("CERC20"); // Loads a compiled contract
...
describe("CompoundLoop", function () {
  ...
  it.only("works", async () => {
    const b = await getBalance(web3, CUSDC_ADDR);
    console.log(b);
  });
});
